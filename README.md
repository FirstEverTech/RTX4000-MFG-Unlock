...
To investigate further, I performed **static analysis of `nvlddmkm.sys`** using [**Ghidra**](https://github.com/NationalSecurityAgency/ghidra), a tool developed by the National Security Agency (the NSA).
...
Update: Verified on driver version 32.0.15.9597 – same behavior.  
See details in the Reverse engineering findings section.
